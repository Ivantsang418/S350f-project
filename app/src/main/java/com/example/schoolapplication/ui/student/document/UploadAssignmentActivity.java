...
public class UploadAssignmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectFileButton = findViewById(R.id.buttonSelectFileSubmitAssignment);
        uploadFileButton = findViewById(R.id.buttonUploadSubmitAssignment);
        filePathView = findViewById(R.id.textViewFileUploadAssignment);
        ...
        uploadFileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (fileUri != null) {
                    ...
                    StorageReference riversRef = storageRef.child("assignments/"+getFileName(fileUri));
