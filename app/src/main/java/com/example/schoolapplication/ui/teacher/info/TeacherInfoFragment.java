package com.example.schoolapplication.ui.teacher.info;
...
public class TeacherInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_info_teacher, container, false);
    ...
    public void onStart() {
        super.onStart();
        RecyclerView recyclerView = view.findViewById(R.id.studentInfoRecyclerView);
    ...
    private void setRecyclerView(RecyclerView recyclerView, List<StudentInfoItem> items) {
        ...
        recyclerView.setAdapter(new StudentInfoAdapter(requireActivity().getApplicationContext(), items, null));
    }
}